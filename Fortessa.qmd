...
CSTGates <- file.path(Computer, "Fortessa.csv")
...
RepairAria <- Data %>% filter(instrument %in% "Fortessa")
...
UVGains <- TheColumnNames[16:22]  
      ...
      YellowGreenGains <- c(TheColumnNames[8:12],TheColumnNames[31])
...
UVGains <- TheColumnNames[15:21]  
      ...
      YellowGreenGains <- c(TheColumnNames[7:11],TheColumnNames[30])
...
## {.sidebar}
Dashboard data for the **BD Fortessa** last updated on **`r TheDate`**
