...
BDSummary <- function (x, Instrument, detectorType = "-A"){
  ...
  if (Instrument == "Fortessa"){
    ...
    UVNames <- NULL
    VioletNames <- TheColumnNames[15:18]
    BlueNames <- TheColumnNames[3:5]
    YellowGreenNames <- TheColumnNames[9:14]
    RedNames <- TheColumnNames[6:8]
  }
...
CSTGates <- file.path(Computer, "Celesta-1.csv")
...
TheColumnNames <- TheIntermediate[str_detect(TheIntermediate, "-A")]
 ...
 VioletGains <- TheColumnNames[9:14]
    BlueGains <- TheColumnNames[3:5]
    YellowGreenGains <- TheColumnNames[15:18]
    RedGains <- TheColumnNames[6:8]
...
TheColumnNames <- TheColumnNames[str_detect(TheColumnNames, "-A")]
 ...
 VioletGains <- TheColumnNames[8:13]
    BlueGains <- TheColumnNames[2:4]
    YellowGreenGains <- TheColumnNames[14:17]
    RedGains <- TheColumnNames[5:7]
