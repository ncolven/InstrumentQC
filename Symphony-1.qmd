...
CSTGates <- file.path(Computer, "Symphony-1.csv")
...
UVGains <- TheColumnNames[19:25]  
      VioletGains <- TheColumnNames[11:18]
      BlueGains <- TheColumnNames[3:7]
      YellowGreenGains <- TheColumnNames[26:30]
      RedGains <- TheColumnNames[8:10]
...
UVGains <- TheColumnNames[18:24]  
      VioletGains <- TheColumnNames[10:17]
      BlueGains <- TheColumnNames[2:6]
      YellowGreenGains <- TheColumnNames[25:29]
      RedGains <- TheColumnNames[7:9]
