...
HTML("
<ul>
  <li><a href='data/Aurora-1/Archive/ArchivedDataAurora-1.csv'>Gain and %rCV</a></li>
  <li><a href='data/Aurora-1/Archive/BeadDataAurora-1.csv'>MFI</a></li>
  <li><a href='data/QCPlots_Aurora-1.pdf'>Plots</a></li>
</ul>
")
```
