...
CSTGates <- file.path(Computer, "Celesta-3.csv")
...
RepairAria <- Data %>% dplyr::filter(instrument %in% "Symphony-2")
...
VioletGains <- TheColumnNames[12:17]
    BlueGains <- TheColumnNames[3:4]
...
VioletGains <- TheColumnNames[11:16]
    BlueGains <- TheColumnNames[2:3]
    YellowGreenGains <- TheColumnNames[7:10]
    RedGains <- TheColumnNames[4:6]
