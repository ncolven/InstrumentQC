...
CSTGates <- file.path(Computer, "Symphony-3.csv")
...
RepairAria <- Data %>% dplyr::filter(instrument %in% "Symphony-3")
...
Filename <- paste0("QCPlots_Symphony-3")

PDF <- Utility_Patchwork(x=PDFPlots, filename=Filename, returntype="pdf", outfolder=MainFolder, thecolumns=1)
```

## {.sidebar}
Dashboard data for the **BD SP Symphony-3** last updated on **`r TheDate`**
