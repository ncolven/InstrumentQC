...
CSTGates <- file.path(Computer, "Symphony-4.csv")
...
RepairAria <- Data %>% filter(instrument %in% "Symphony-4")
...
UVGains <- TheColumnNames[20:27]  
VioletGains <- TheColumnNames[12:19]
BlueGains <- TheColumnNames[3:8]
YellowGreenGains <- TheColumnNames[28:32]
RedGains <- TheColumnNames[9:11]
...
UVGains <- TheColumnNames[19:26]  
VioletGains <- TheColumnNames[11:18]
BlueGains <- TheColumnNames[2:7]
YellowGreenGains <- TheColumnNames[27:31]
...
Filename <- paste0("QCPlots_Symphony-4")
