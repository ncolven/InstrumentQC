...
CSTGates <- file.path(Computer, "Symphony-5.csv")
...
RepairAria <- Data %>% dplyr::filter(instrument %in% "Symphony-5")
...
TheColumnNames <- TheIntermediate[str_detect(TheIntermediate, "-A")]
    ...
    YellowGreenGains <- TheColumnNames[36:45]
    RedGains <- TheColumnNames[46:51]
...
TheColumnNames <- TheColumnNames[str_detect(TheColumnNames, "-A")]
    ...
    YellowGreenGains <- TheColumnNames[35:44]
